<template>
  <vue-final-modal v-model="showModal" name="example" :esc-to-close="true">
        ...
        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
          ...
          <div>
            ...
            <div class="mt-1 flex items-center">
              ...
              <button type="button"
                      class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Change
              </button>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      calendarOptions: {
        ...
        selectionInfo: this.handleSelect,
  ...
  methods: {
    ...
    handleEventClick: function (arg) {
      // console.log("event click", arg.event.start);
    },
    createEvent: () => {
      console.log("create");
    }
